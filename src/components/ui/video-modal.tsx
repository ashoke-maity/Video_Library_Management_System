...
export function VideoModal({ video, isFavorite, onClose, onToggleFavorite }: VideoModalProps) {
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-gray-900 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-700 shadow-2xl animate-scale-in">
        ...
        <div className="relative">
          <div className="h-80 rounded-t-2xl relative overflow-hidden" style={{ backgroundColor: video.coverColor }}>
            {/* Gradient overlay */}
