...
export function CinematicShelf({ 
  ...
  const genreColor = genreColors[selectedGenre as keyof typeof genreColors] || genreColors.all
  const genreTheme = genreThemes[selectedGenre as keyof typeof genreThemes] || genreThemes.all
    ...
    <div className="relative min-h-[80vh] overflow-hidden">
      ...
      <div className="relative z-10 py-12">
        ...
        >
          ...
          >
            {selectedGenre === "all" ? "All Videos" : `${selectedGenre} Collection`}
          </h2>
          <div 
              ...
              >
                ...
                >
                  ...
                  <div 
                    ...
                    style={{ 
                      background: `linear-gradient(135deg, ${genreColor}60, ${video.coverColor || genreColor}40)`
                    }}
                  >
                    {/* Play Button */}
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <Heart className={`w-3 h-3 ${favorites?.includes(video.id) ? 'fill-current text-red-500' : ''}`} />
                        </Button>
              ...
              <div className="flex space-x-2">
                {[...Array(totalPages)].map((_, index) => (
                  <button
                    ...
                    style={{
                      backgroundColor: currentPage === index ? genreColor : 'rgba(255,255,255,0.3)',
                      boxShadow: currentPage === index ? `0 0 15px ${genreColor}` : 'none'
                    }}
                  />
                ))}
              </div>
