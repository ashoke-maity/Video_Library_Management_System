...
import { Play, Heart, Star, Clock, Eye, MoreVertical, Share2, Bookmark } from "lucide-react"
...
interface VideoCardProps {
  ...
  variant?: "default" | "carousel" | "featured"
}
      ...
      <div className="relative bg-background-elevated rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-500 hover:scale-105 hover:shadow-2xl cursor-pointer glass-effect">
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <span
              className={`px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r ${getGenreColor(video.genre)} text-white shadow-lg`}
            >
          ...
          <div className="flex items-center justify-between text-xs text-gray-400">
            <span className="flex items-center gap-1">
              ...
              <span className="font-medium">{video.watchCount.toLocaleString()}</span> views
            </span>
        ...
        {/* Only show the play button overlay on hover, keep description and details always visible */}
