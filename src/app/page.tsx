...
import { Sparkles, TrendingUp, Clock, Heart, Star, Play, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Home() {
  ...
  const recentVideos = mockVideos.slice(0, 10);
  ...
  // Helper function to render videos based on view mode
  const renderVideos = (videos: Video[], sectionTitle: string) => {
  ...
  return (
    <div className="min-h-screen bg-background-primary relative overflow-hidden">
      ...
      {/* Hero Section with Image Sliding */}
      ...
      <div className="relative z-10 px-6">
        ...
        {trendingVideos.length > 0 && (
          <section className="mb-16">
            ...
            {renderVideos(trendingVideos.slice(0, 8), "Trending")}
          </section>
        )}
        ...
        {recentlyWatched.length > 0 && (
          <section className="mb-16">
            ...
            {(() => {
              const recentVideos = recentlyWatched.slice(0, 5).map(videoId => 
                mockVideos.find(v => v.id === videoId)
              ).filter(Boolean) as Video[];
              return renderVideos(recentVideos, "Recently Watched");
            })()}
          </section>
        )}
        ...
        <section>
          ...
          {filteredVideos.length === 0 ? (
            ...
            <div className="animate-fade-in">
              {renderVideos(filteredVideos, "Main Collection")}
            </div>
          )}
        </section>
      </div>
