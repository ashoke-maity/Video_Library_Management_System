    ...
    <div className="w-full h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 p-6">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-4xl font-bold text-white tracking-wider">CINEMATIC LIBRARY</h1>
      ...
      {/* 3D Scene */}
      <Canvas camera={{ position: [0, 5, 15], fov: 60 }} shadows gl={{ antialias: true, alpha: false }}>
        <Suspense
          fallback={
            <Html center>
        ...
        >
          <CinematicLibrary videos={filteredVideos} selectedGenre={selectedGenre} onVideoSelect={setSelectedVideo} />
          <OrbitControls enablePan={false} maxPolarAngle={Math.PI / 2} minDistance={10} maxDistance={25} />
